<template>
    <div class="w-11/12 m-auto mt-10 lg:w-2/3">
        ...
        <p class="mt-5">
            Learn<br />Maximilian Klackl<br />Mastaliergasse 27, <br />4820
            Musterhausen, <br />Österreich
        </p>
        <p class="mt-5">
            ...
            <strong>Firmensitz:</strong> Timbuktu
        </p>
        <p class="mt-5">
        ...
        <p class="mt-5">
            ...
            Bezirkshauptmannschaft Musterhausen<br />
            <strong>Berufsbezeichnung:</strong> der Programmierer<br />
            <strong>Verleihungsstaat:</strong> Österreich
        </p>
        <h2 class="mt-5 text-2xl font-bold">Urheberrechtshinweis</h2>
        <p>
        ...
        <h2 class="mt-5 text-2xl font-bold">EU-Streitschlichtung</h2>
        <p>
            ...
            <a
                ...
                >http://ec.europa.eu/odr?tid=221146190</a
            >
...
export default {
    created() {
        document.title = "Learn - Impressum";
    },
};
</script>
